...
export interface ContactFormData { title: string; subtitle?: string; fields: FormField[]; submitUrl: string; submitText?: string; contactInfo?: ContactInfo; layout?: "side-by-side"|"form-only"; settings?: any; }
